...
These are the default settings in :file:`armyimp/manage.py`.
...
:py:class:`armyimp.config.settings.common.Common`.
...
.. list-table::
    ...
    * - ``STATIC_ROOT``
      - ``'<full path to armyimp>/static_root/'``
      - ``DJANGO_STATIC_ROOT``
...
:py:class:`armyimp.config.settings.databases.Databases`.

The following classes inherit from it:

* :py:class:`armyimp.config.settings.dev.Development`
* :py:class:`armyimp.config.settings.public.Production`
* :py:class:`armyimp.config.settings.public.Staging`
* :py:class:`armyimp.config.settings.test.Testing`
...
:py:class:`armyimp.config.settings.email.SMTP`
...
from :py:class:`armyimp.config.settings.email.Mailgun`
to use these settings.
...
from :py:class:`armyimp.config.settings.public.Raven`
to use these settings.
...
The class
:py:class:`armyimp.config.settings.public.Public`
...
from :py:class:`armyimp.config.settings.public.SSL`
to use these settings.
:py:class:`armyimp.config.settings.public.Production`
