...
class Common(Configuration):
    ...
    ALLOWED_HOSTS = values.ListValue(['armyimp.net'])
    ...
    ROOT_URLCONF = 'armyimp.config.urls'

    WSGI_APPLICATION = 'armyimp.config.wsgi.application'
    ...
    TEMPLATES = [
        {
            ...
            'OPTIONS': {
                'context_processors': [
                    ...
                    'armyimp.context_processors.django_version',
                ],
    ...
    GRAPPELLI_ADMIN_TITLE = 'armyimp Admin'

    EMAIL_SUBJECT_PREFIX = '[armyimp]'
